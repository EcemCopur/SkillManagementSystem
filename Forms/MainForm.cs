...
namespace SkillManagementSystem
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeCustomComponents()
        {
            ...
            fileMenu.DropDownItems.Add(CreateMenuItem("Import from Excel", ImportFromExcel));
        ...
        {
            var form = new Forms.ImportDataForm(dataManager);
            if (form.ShowDialog() == DialogResult.OK)
            {
                // Data was imported successfully
                MessageBox.Show("Data imported and saved successfully!", "Success",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }

        // Event Handlers for Menu Items - Data Management
        ...
        {
            var form = new Forms.TrainingManagementForm(dataManager);
            form.ShowDialog();
        }

        private void OpenProcessManagement(object sender, EventArgs e)
        {
            var form = new Forms.ProcessManagementForm(dataManager);
            form.ShowDialog();
        }

        // Event Handlers for Menu Items - Analysis
        private void OpenEmploymentAnalysis(object sender, EventArgs e)
        {
            var form = new Forms.EmploymentAnalysisForm(dataManager);
            form.ShowDialog();
        }

        private void OpenCapabilityEnhancement(object sender, EventArgs e)
        {
            var form = new Forms.CapabilityEnhancementForm(dataManager);
            form.ShowDialog();
        }

        private void OpenWorkerReliance(object sender, EventArgs e)
        {
            var form = new Forms.WorkerRelianceForm(dataManager);
            form.ShowDialog();
        }

        // Event Handlers for Menu Items - Reports
        private void OpenDashboard(object sender, EventArgs e)
        {
            MessageBox.Show("Dashboard - Coming Soon!", "Information",
                MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void OpenDepartmentReports(object sender, EventArgs e)
        {
            MessageBox.Show("Department Reports - Coming Soon!", "Information",
                MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void OpenTrainingReports(object sender, EventArgs e)
        {
            MessageBox.Show("Training Reports - Coming Soon!", "Information",
                MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
