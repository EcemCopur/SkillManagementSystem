...
namespace SkillManagementSystem.Forms
{
    public partial class EmployeeEditForm : Form
    {
        ...
        private void LoadEmployeeData()
        {
            ...
            cmbDepartment.SelectedValue = employee.DepatmentId;
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                employee.DepatmentId = (int)cmbDepartment.SelectedValue;
        ...
        private void TrackChanges()
        {
            ...
            if (employee.DepatmentId != (int)cmbDepartment.SelectedValue)
            {
                var history = new ChangeHistory
                {
                    Id = dataManager.ChangeHistories.Any() ? dataManager.ChangeHistories.Max(h => h.Id) + 1 : 1,
                    ...
                    OldValue = dataManager.Departments.FirstOrDefault(d => d.Id == employee.DepatmentId)?.Name ?? "N/A",
